      ...
      if ($(".embed-lazy").length) {
        $(".embed-lazy .preview").on("click", function() {
          ...
          let html =
            '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="' +
            url +
            '?autoplay=1&amp;modestbranding=1&amp;showinfo=0"  allowscriptaccess="always" allow="autoplay"></iframe></div>';
          $("#custom-modal")
            .find(".modal-body")
            .html(html);
          $("#custom-modal").modal("show");
      ...
      if (resize === false) {
        ...
        $(".slick-shows")
          ...
          .on("beforeChange", function(ev, slick, cur, next) {
            ...
            let setSlug =
              typeof slug !== "undefined" ? slug.replace(/cat-/, "") + "/" : "";
