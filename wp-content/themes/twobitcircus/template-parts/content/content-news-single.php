  ...
  <div class="main-headline header-bkg-right container-fluid" style="background-image: url('/wp-content/uploads/2019/09/CLUB01-HIGHLIGHTS-FINAL-2.jpg');background-position: 0 60%;">
    <div class="row h-100">
      ...
      <div class="header-bkg-left py-5 my-auto">
        <h1 class="headline inview animated text-center fadeInDown" data-ease="fadeInDown">Latest News</h1>
        <div class="text-center content mx-auto inview animated fadeInUp"><p>Read on to learn more about what’s happening at the circus.</p></div>
      </div>
    </div>
  </div>
  ...
  <section id="news-content" class="entry-wrapper-padding inview animated delay-1">
    <div class="container white">
      <div class="row">
        ...
        <div class="col-md-6">
          <h2 class="headline lubalinB inview animated"><?php the_title();?></h2>
