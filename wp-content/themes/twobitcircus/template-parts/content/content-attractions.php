                                            ...
                                            <div class="slick-times">
                                                ...
                                                <div class="item-time">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="cta-btn mb-2"><a class="btn btn-twobit btn-white btn-sm" href="https://twobitcircus.centeredgeonline.com<?php echo $timeInfo->link; ?>" target="_blank" rel="noopener noreferrer"><span><?php echo $timeInfo->ticket; ?></span></a>
                                                            <div class="btn-behind sm">&nbsp;</div>
                                                        </div>
                                                        <?php else: ?>
                                                        <div class="cta-btn mb-2"><a class="btn btn-twobit btn-sm btn-disabled"><span><?php echo $timeInfo->ticket; ?></span></a>
                                                            <div class="btn-behind sm">&nbsp;</div>
                                                        </div>
                                                        <?php endif?>
                                                        <?php endforeach?>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapse-<?php echo $show->ID; ?>-<?php echo $date; ?>" class="collapse" data-parent="#accordion-<?php echo $show->ID; ?>">
                                                    <div class="card-body">
                                                        ...
                                                        <?php if ($timeInfo->outstock != 1): ?>
                                                        <div class="cta-btn"><a class="btn btn-twobit btn-green btn-sm" href="https://twobitcircus.centeredgeonline.com<?php echo $timeInfo->link; ?>" target="_blank" rel="noopener noreferrer"><span><?php echo $timeInfo->ticket; ?></span></a>
                                                            <div class="btn-behind sm">&nbsp;</div>
                                                        </div>
                                                        <?php else: ?>
                                                        <div class="cta-btn"><a class="btn btn-twobit btn-sm btn-disabled"><span><?php echo $timeInfo->ticket; ?></span></a>
                                                            <div class="btn-behind sm">&nbsp;</div>
                                                        </div>
                                                        <?php endif?>
