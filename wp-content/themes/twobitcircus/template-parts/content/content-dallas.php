...
$promotionContent = get_field('promotion_content', $eventId)[$locTarget];
?>
                ...
                <div class="hours-col col-md-5 col-lg-4 col-xl-3">
                    ...
                    <div class="directions inview animated pb-3 delay-2">
                        <div class="text-content flex-content mx-auto text-center">
                            ...
                            <a class="map-link walk" href="<?php echo $location['walking_map_link']; ?>" target="_blank" rel="noopener"><svg aria-hidden="true" data-prefix="fas" data-icon="walking" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svg-inline--fa fa-walking fa-w-10">
                                    <path fill="currentColor" d="M208 96c26.5 0 48-21.5 48-48S234.5 0 208 0s-48 21.5-48 48 21.5 48 48 48zm94.5 149.1l-23.3-11.8-9.7-29.4c-14.7-44.6-55.7-75.8-102.2-75.9-36-.1-55.9 10.1-93.3 25.2-21.6 8.7-39.3 25.2-49.7 46.2L17.6 213c-7.8 15.8-1.5 35 14.2 42.9 15.6 7.9 34.6 1.5 42.5-14.3L81 228c3.5-7 9.3-12.5 16.5-15.4l26.8-10.8-15.2 60.7c-5.2 20.8.4 42.9 14.9 58.8l59.9 65.4c7.2 7.9 12.3 17.4 14.9 27.7l18.3 73.3c4.3 17.1 21.7 27.6 38.8 23.3 17.1-4.3 27.6-21.7 23.3-38.8l-22.2-89c-2.6-10.3-7.7-19.9-14.9-27.7l-45.5-49.7 17.2-68.7 5.5 16.5c5.3 16.1 16.7 29.4 31.7 37l23.3 11.8c15.6 7.9 34.6 1.5 42.5-14.3 7.7-15.7 1.4-35.1-14.3-43zM73.6 385.8c-3.2 8.1-8 15.4-14.2 21.5l-50 50.1c-12.5 12.5-12.5 32.8 0 45.3s32.7 12.5 45.2 0l59.4-59.4c6.1-6.1 10.9-13.4 14.2-21.5l13.5-33.8c-55.3-60.3-38.7-41.8-47.4-53.7l-20.7 51.5z" class=""></path>
                                </svg></a>
    ...
    <section id="parties-block" class="entry-wrapper-padding inview animated" style="background-color: #000;">
        ...
        <div class="container-fluid">
            ...
            <div class="content-block container mt-2 mb-6 px-md-5">
                <h2 class="default white"><?php echo $promotionContent['title']; ?></h2>
                <div class="white"><?php echo $promotionContent['content']; ?></div>
            </div>
            <?php endif?>

            <div class="grid-flex">
                <?php foreach ($events as $shows): ?>
                <div class="grid-item card" data-loc="TX" data-event="<?php echo $shows['event_type']; ?>" id="<?php echo sanitize_title($shows['title']); ?>">
                    ...
                    <div class="card-body text-left collapse fade">
                        ...
                        <div class="link-wrapper my-2">
                            <div class="cta-btn mx-auto"><a class="btn btn-twobit" data-toggle="modal" data-target="#event-form" href="#"><span><?php echo $shows['event_cta_title']; ?></span></a>
    ...
    <section id="venue-block" class="entry-wrapper-padding">
        <div class="container">
            ...
            <div class="venue-wrapper accordion-wrapper inview animated delay-1 clearfix">
                <?php foreach ($venue_details as $vkey => $venue): if ($venue['locations'] != 'Dallas|Texas' && $venue['locations'] != 'all|all') {continue;}?>
