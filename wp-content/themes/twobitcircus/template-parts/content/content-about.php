...
<article id="about" <?php post_class(); ?>>
  ...
  <section id="about-header">
    ...
    <div class="container text-center caption-bottom">
      <h1 class="headline mx-auto inview animated delay-3"><?php echo get_field('header_title');?></h1>
      <div class="w-75 mx-auto inview animated delay-4"><?php echo get_field('header_description');?></div>
